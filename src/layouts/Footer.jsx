      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-6 py-8 text-sm text-slate-200/80">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
          ...
          <div className="flex-1 mb-4 md:mb-0">
            ...
            <p className="text-slate-300/80 mb-3 whitespace-nowrap">Your Vision, Digitally Crafted—one solution at a time, always evolving.</p>
        ...
        <div className="mt-8 flex flex-col md:flex-row md:justify-between md:items-center border-t border-white/10 pt-4 text-xs text-slate-400/80 gap-2">
          <span>© 2026 DevLab Studios. All rights reserved.</span>
